...
URL = "https://github.com/mikejgray/dice-skill"
SKILL_CLAZZ = "DiceSkill"  # needs to match __init__.py class name
PYPI_NAME = "dice-skill"  # pip install PYPI_NAME
